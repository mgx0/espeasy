...
#define PLUGIN_ValueNAME1_111 "code"
#define PLUGIN_ValueNAME2_111 "pulselength"
#define PLUGIN_ValueNAME3_111 "bitlength"
...
boolean Plugin_111(byte function, struct EventStruct *event, String& string)
{
        ...
        case PLUGIN_DEVICE_ADD:
        {
                ...
                Device[deviceCount].VType = Sensor_VType::SENSOR_TYPE_TRIPLE; //SENSOR_TYPE_LONG;
                ...
                if (rfReceiver->available())
                {
                        ...
                        if (valuerf == 0) {
                                ...
                                //UserVar[event->BaseVarIndex + 1] = ((valuerf >> 16) & 0xFFFF);
                                 ...
                                 UserVar[event->BaseVarIndex + 0] = rfReceiver->getReceivedValue();
                                 UserVar[event->BaseVarIndex + 1] = rfReceiver->getReceivedDelay();
                                 UserVar[event->BaseVarIndex + 2] = rfReceiver->getReceivedBitlength();
