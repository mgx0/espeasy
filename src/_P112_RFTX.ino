...
boolean Plugin_112(byte function, struct EventStruct *event, String& string)
{
        ...
        {
                Plugin_112_Bits = web_server.arg("plugin_112_bits").toInt();
                Plugin_112_Pulse = web_server.arg("plugin_112_pulse").toInt();
                Plugin_112_Repeat = web_server.arg("plugin_112_repeat").toInt();
        ...
        case PLUGIN_WRITE:
        {
                ...
                if (tmpString.equalsIgnoreCase("RFSWITCHTYPEA") && rcswitchSender != 0)
                {
                        ...
                        if (GetArgv(command, TmpStr1, 2)) Plugin_112_iCode = str2int(TmpStr1.c_str());
                        if (GetArgv(command, TmpStr2, 3)) TmpStr2.toCharArray(Plugin_112_sGroup, 80);
                        if (GetArgv(command, TmpStr3, 4)) TmpStr3.toCharArray(Plugin_112_sDevice,80);
                        if (GetArgv(command, TmpStr4, 5)) Plugin_112_Repeat = str2int(TmpStr4.c_str());
                ...
                else if (tmpString.equalsIgnoreCase("RFSWITCHTYPED") && rcswitchSender != 0)
                {
                        ...
                        if (GetArgv(command, TmpStr1, 2)) Plugin_112_iCode = TmpStr1.toInt();
                        if (GetArgv(command, TmpStr1, 3)) Plugin_112_nDevice = TmpStr1.toInt();
                        if (GetArgv(command, TmpStr2, 4)) Plugin_112_csGroup = TmpStr1.toInt();
                        if (GetArgv(command, TmpStr1, 5)) Plugin_112_Repeat = TmpStr1.toInt();
                ...
                else if (tmpString.equalsIgnoreCase("RFTRISTATE") && rcswitchSender != 0)
                {
                        ...
                        if (GetArgv(command, TmpStr1, 2)) TmpStr1.toCharArray(Plugin_112_sCodeWord, 80);
                        if (GetArgv(command, TmpStr2, 3)) Plugin_112_Repeat = TmpStr1.toInt();
